package com.gs.crms.businessmonitoring.contract.service;
 ...
 * 管理员查询申请相关服务
 */
public interface CertificateApplyForAdminService {
     ...
     * @return
     */
    ReturnBase<List<CertificateApplyInfo>> getCertificateApplyInfo(String orgPersonId, ApplyInfoParam applyInfoParam,boolean isPrority);
